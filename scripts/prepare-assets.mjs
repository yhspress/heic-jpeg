...
const adsense = JSON.parse(await readFile(new URL("../src/config/adsense.json", import.meta.url), "utf8"));
const client=process.env.NEXT_PUBLIC_ADSENSE_CLIENT ?? adsense.publisherId;
